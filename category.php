...
<ul>
    ...
    <li class="relative px-6 py-3">
        ...
        <a
                ...
                href="category.php"
        >
            <svg stroke-linejoin="round" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Outline"
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto ">
            ...
            <div style='margin-top:40px' class="grid gap-6 mb-8 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2">
                <?php
                categories_delete($conn);
                ?>

                <?php
                $server_select = server_select($conn);
                if (is_array($server_select) || is_object($server_select)) {
                    foreach ($server_select
                             as $value):
                        ?>


                        <div class="shadow-md rounded-2xl bg-white dark:bg-gray-800 p-4 ">
                            <div class="flex-row gap-4 flex justify-center items-center">
                                <div class="flex-shrink-0">
                                    <a href="#" class="relative block">
                                        <img alt="profil" src="icons/wizwizlogo.jpg"
            ...
            <span class="text-lg font-medium text-gray-600 dark:text-white">
                ...
                wizwiz
                                ...
                                <a id="ts-error" href="category.php?delete=<?php echo $value['id']; ?>">
        ...
        <form id="insert_category">
            ...
            <div class="mt-4 mb-6">
                ...
                <div class="flex relative mt-4">
                    ...
                    <input required name="title_category" style="font-size: 14px;" type="text" id="with-email"
                           ...
                           name="url" placeholder="<?php echo $_LANG['Write']?>"/>
                </div>
            </div>
            <footer class="flex flex-col items-center justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
                <button name="add_category_title" type="submit" @click="closeModal"
