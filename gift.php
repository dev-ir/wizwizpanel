            ...
            <section style='margin-top:40px' class="w-full p-6 mx-auto bg-white rounded-md shadow-sm dark:bg-gray-800">
                <form id="insert_gift">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-left">
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2 " s for="username"><?php echo $_LANG['id']?></label>
                            <input required name="id_user" value="" id="username"
                                   type="number"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username"><?php echo $_LANG['gift']?></label>
                            <input required name="gift" value="" id="username"
                                   type="number"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username"><?php echo $_LANG['buttontext']?></label>
                            <input required name="button" value="" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="username"><?php echo $_LANG['buttonurl']?></label>
                            <input required name="url" value="" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                    </div>
                    <div class="flex justify-end mt-6">
                        <button name="save_git" type="submit"
                                class="px-8 py-2.5 leading-5 transition-colors duration-300 transform">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" fill="#0eb2c5" data-name="Layer 1"
                                 viewBox="0 0 24 24" width="21" height="21">
                                <path d="M21,7H17.866A6.547,6.547,0,0,0,20,2H18c0,2.881-1.971,4.307-4.152,4.8A9.239,9.239,0,0,0,15,3,3,3,0,0,0,9,3a9.239,9.239,0,0,0,1.152,3.8C7.971,6.307,6,4.881,6,2H4A6.547,6.547,0,0,0,6.134,7H3a3,3,0,0,0-3,3v4H2V24H22V14h2V10A3,3,0,0,0,21,7ZM12,2a1,1,0,0,1,1,1,7.71,7.71,0,0,1-1,3.013A7.71,7.71,0,0,1,11,3,1,1,0,0,1,12,2ZM2,10A1,1,0,0,1,3,9h8v3H2Zm2,4h7v8H4Zm16,8H13V14h7Zm2-10H13V9h8a1,1,0,0,1,1,1Z"/>
                            </svg>
