...
<ul>
    ...
    <li class="relative px-6 py-3">
        ...
        <a
                ...
                href="settings.php"
        >
            <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="21"
                 height="21">
        ...
        <div class="container grid px-6 mx-auto ">
                ...
                <form id="save_admin">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-left" style="font-size: 14px">
                        <div class="mt-2">
                            ...
                            <input required name="username" value="<?php echo $value["username"]; ?>" id="username"
                                   type="text"
                        ...
                        <div class="mt-2">
                            ...
                            <input required name="password" value="<?php echo $value["password"]; ?>" id="username"
                                   type="password"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                    </div>
                ...
                <form id="save_backup">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-left" style="font-size: 14px">
                        <div class="mt-2">
                            ...
                            <input required name="backupchannel" value="<?php echo $value["backupchannel"]; ?>" id="username"
                                   type="text"
                                   class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                        </div>
                    </div>
            ...
            <section class="mt-5 w-full p-6 mx-auto bg-white rounded-md shadow-sm dark:bg-gray-800">
                <form id="save_backup">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 text-left" style="font-size: 14px">
                        <div class="mt-2">
                            <label class="text-gray-700 dark:text-gray-200 mt-2" for="verify_user"><?php echo $_LANG['verify_user']?></label>
                            <input required name="verify_user" value="<?php echo @$value["verify_user"]; ?>" id="verify_user" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring">
                            <h6 class="text-white">
                                در این حالت کاربران جهت مشاهده اطلاعات پرداخت میبایست کد معرف دریافت کنند.
                            </h6>
                        </div>
                    </div>
                    <div class="flex justify-end mt-6">
