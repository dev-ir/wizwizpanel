...
<div
        ...
        class="fixed  z-10 flex items-end bg-black bg-opacity-20 sm:items-center sm:justify-center"
></div>
<aside
        class="fixed  z-20 flex-shrink-0 w-64 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
        x-show="isSideMenuOpen"
        x-transition:enter="transition ease-in-out duration-150"
...
>
    ...
    <li class="relative px-6 py-3">
        ...
        >
            ...
            <li style="z-index: 20" class="relative px-6 py-3">
                <a
                        class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        href="software.php">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" fill="gray" data-name="Layer 1"
            ...
            <div class="shadow-xl min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 text-xs font-semibold tracking-wide text-left text-gray-500 border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                <div class="w-full overflow-x-auto  text-center">
                    <table class="w-full whitespace-no-wrap  text-center">
                        ...
                        <?php
                        $orders_list_select = orders_list($conn);
                        if (is_array($orders_list_select) || is_object($orders_list_select)) {
                            foreach ($orders_list_select
                                     as $value):
