...
<div class="flex flex-col flex-1 w-full">
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto ">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="gray" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24"
                     width="21" height="21">
                    <path d="M23,12.5A1.5,1.5,0,0,1,21.5,14H18.63a3.516,3.516,0,0,1-3-1.7l-1.225-2.034-1.79,4.363,2.614,1.487A3.507,3.507,0,0,1,17,19.163V22.5a1.5,1.5,0,0,1-3,0V19.163a.5.5,0,0,0-.252-.434L9.666,16.406a3.511,3.511,0,0,1-1.427-4.322L9.5,9H7.736a.5.5,0,0,0-.447.277L5.842,12.171a1.5,1.5,0,0,1-2.684-1.342L4.605,7.935A3.483,3.483,0,0,1,7.736,6H13.36a3.516,3.516,0,0,1,3,1.7L18.2,10.758A.5.5,0,0,0,18.63,11H21.5A1.5,1.5,0,0,1,23,12.5ZM8.057,16.85a1.5,1.5,0,0,0-1.95.836A.5.5,0,0,1,5.643,18H3.5a1.5,1.5,0,0,0,0,3H5.643a3.484,3.484,0,0,0,3.25-2.2A1.5,1.5,0,0,0,8.057,16.85ZM14.5,5A2.5,2.5,0,1,0,12,2.5,2.5,2.5,0,0,0,14.5,5Z"/>
                </svg>
            ...
            <div style='margin-top:40px' class=" w-full flex justify-center items-center grid gap-6 mb-8 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1">
                ...
                while ($row_plans = $result_plans->fetch_assoc()) {
                    ...
                    echo '
<div class="w-full p-4 m-auto bg-white shadow-lg rounded-2xl dark:bg-gray-800">
    <div class="w-full h-full text-center">
        <div class="flex flex-col justify-between h-full">
            <div class="mx-auto m-4">
 <svg xmlns="http://www.w3.org/2000/svg" fill="#5f7d95" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="45" height="45"><path d="M23,12.5A1.5,1.5,0,0,1,21.5,14H18.63a3.516,3.516,0,0,1-3-1.7l-1.225-2.034-1.79,4.363,2.614,1.487A3.507,3.507,0,0,1,17,19.163V22.5a1.5,1.5,0,0,1-3,0V19.163a.5.5,0,0,0-.252-.434L9.666,16.406a3.511,3.511,0,0,1-1.427-4.322L9.5,9H7.736a.5.5,0,0,0-.447.277L5.842,12.171a1.5,1.5,0,0,1-2.684-1.342L4.605,7.935A3.483,3.483,0,0,1,7.736,6H13.36a3.516,3.516,0,0,1,3,1.7L18.2,10.758A.5.5,0,0,0,18.63,11H21.5A1.5,1.5,0,0,1,23,12.5ZM8.057,16.85a1.5,1.5,0,0,0-1.95.836A.5.5,0,0,1,5.643,18H3.5a1.5,1.5,0,0,0,0,3H5.643a3.484,3.484,0,0,0,3.25-2.2A1.5,1.5,0,0,0,8.057,16.85ZM14.5,5A2.5,2.5,0,1,0,12,2.5,2.5,2.5,0,0,0,14.5,5Z"/></svg>
</div>
            ...
            <p class="px-6 py-2 text-xs text-gray-600 dark:text-gray-400">
               ' . $row_plans['days'] . ' Days - ' . $row_plans['volume'] . ' GB - ' . $row_plans['protocol'] . ' ' . $row_plans['type'] . '
            </p>';
...
<div class="flex relative m-2">
    ...
    <input required name="price_plan" style="font-size: 14px;" value="' . $value["price"] . '" type="text" id="with-email" class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-blue-400 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent" name="url" placeholder="www.google.com"/>
    </div>
...
<div class="flex relative m-2">
    ...
    <input required name="days_plan" style="font-size: 14px;" value="' . $value["days"] . '" type="text" id="with-email" class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-blue-400 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent" name="url" placeholder="www.google.com"/>
    </div>
    ...
    <input required name="volume_plan" style="font-size: 14px;" value="' . $value["volume"] . '" type="text" id="with-email" class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-blue-400 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent" name="url" placeholder="www.google.com"/>
    </div>
';
...
<div class="flex relative m-2">
    ...
    <input name="inbound_id_plan" style="font-size: 14px;" value="' . $value["inbound_id"] . '" type="text" id="with-email" class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-blue-400 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent" name="url" placeholder="www.google.com"/>
    </div>
...
<br>
            ...
            if (isset($_POST['btn_edit'])) {
                ...
                $sql_server_plans = "UPDATE server_plans SET title=?,protocol=?, type=?,price=?,days=?,volume=?,limitip=?,inbound_id=?,descr=?,catid=?,server_id=?,acount=?,custom_path=?,custom_port=?,custom_sni=? WHERE id = ?";
				$stmt = $conn->prepare($sql_server_plans);
				$stmt->bind_param('sssiiiiisiiisssi', $title_plans, $protocol_plans, $type_plans, $price_plans, $days_plans, $volume_plans, $limitip_plans, $inbound_id_plans, $description_plans, $name_category_wizwiz_plans, $name_server_wizwiz_plans, $acount_plans, $custom_path_planss, $custom_port_planss, $custom_sni_planss, $value['id']);
				$stmt->execute();
...
<!--                </div>-->
                ...
                <div class="flex relative m-2">
                    <span class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-l-md inline-flex  items-center px-3 border-t bg-white border-l border-b  border-gray-300 text-gray-500 shadow-sm text-sm">
                         <?php echo $_LANG['count']?> <span style="font-size: 11px;margin-left: 8px"> <?php echo $_LANG['countdes']?> </span>
                    </span>
                ...
                <div class="m-1">
                    <label class="text-gray-600" for="name" style="font-size: 14px">
                        <textarea placeholder="<?php echo $_LANG['Descriptiontitle']?>" name="description" style="font-size: 14px"
