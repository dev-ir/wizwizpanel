...
<ul>
    ...
    <li class="relative px-6 py-3">
        <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="category.php">
            <svg stroke-linejoin="round" fill="gray" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" id="Outline"
    ...
    <li class="relative px-6 py-3">
        ...
        <a
                ...
                href="discount.php"
        >
            <svg id="Layer_1" height="21" viewBox="0 0 24 24" width="21" xmlns="http://www.w3.org/2000/svg"
                 data-name="Layer 1">
...
<div class="flex flex-col flex-1 w-full">
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto ">
            ...
            >
                <svg id="Layer_1" height="21" viewBox="0 0 24 24" width="21" fill="gray"
            ...
            <div style='margin-top:40px'  class="grid gap-6 mb-8 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2">
                <?php
                discounts_delete($conn);

                $discounts_select = discounts_select($conn);
                if (is_array($discounts_select) || is_object($discounts_select)) {
                    foreach ($discounts_select
                             as $value):
                        $timestamp = $value["expire_date"];
                        $date = jdate('Y-m-d', $timestamp);
                        ?>

                        <div class="shadow-sm rounded-2xl bg-white dark:bg-gray-800 p-4 ">
            ...
            <span style="font-weight: bold" class="text-lg text-left font-medium text-gray-600 dark:text-white ">
                <?php echo $value['hash_id']; ?>
            </span>
                                    <span class="text-xs text-gray-700 mt-2 text-left dark:hover:text-gray-200 dark:text-gray-100">
                <?php
                if ($timestamp == '0') {
                    echo '<p class="mt-2" style="font-size: 13px">Expiry-date:<span style="color: #ef233c;"> 0 </span></p>';
                } else {
                    echo '<p class="mt-2" style="font-size: 13px">Expiry-date: <span style="color: #38b000;">' . $date . ' </span></p>';
                }
                if ($value["expire_count"] == '0') {
                ...
                if ($value["type"] == 'amount') {
                    ...
                    echo '<p class="mt-2" style="font-size: 13px">Percent:<span style="color: #38b000;"> ' . $value["amount"] . '% </span></p>';
                }
                ?>
            </span>
                                </div>
                                <a id="ts-error" href="discount.php?delete=<?php echo $value['id']; ?>">
...
>
    ...
    >
        ...
        <?php
        discounts_insert($conn);
        ?>
        <form id="insert_discount">
            <!-- Modal body -->
            <div class="mt-4 mb-6">
                <!-- Modal title -->
                <p class="m-2 text-lg font-semibold text-gray-700 dark:text-gray-300">
                    <?php echo $_LANG['adddiscounts']?>
                </p>
                <p style="font-size: 14px; color: #d81159" class="mt-2">
                    <?php echo $_LANG['tozih']?>
                </p>
                <label class="block mt-5 text-sm mx-auto">
                    <select required name="category_discounts"
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                        <option value="amount"><?php echo $_LANG['price']?></option>
                        <option value="percent"><?php echo $_LANG['percent']?></option>
                    </select>
                </label>
                ...
                <div class="flex relative mt-4">
                    <span class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-l-md inline-flex  items-center px-3 border-t bg-white border-l border-b  border-gray-300 text-gray-500 shadow-sm text-sm">
                        <?php echo $_LANG['pricepercent']?>
                    </span>
                    <input required name="percent_discounts" style="font-size: 14px;" type="number" id="with-email"
                ...
                <div class="flex relative mt-4">
                    <span class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-l-md inline-flex  items-center px-3 border-t bg-white border-l border-b  border-gray-300 text-gray-500 shadow-sm text-sm">
                       <?php echo $_LANG['expiredate']?>
                    </span>
                    <input required name="discounts_date" style="font-size: 14px;" type="number" id="with-email"
                           class="dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-blue-400 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent"
                           name="url" placeholder="Write a name for the category..."/>
                </div>
                <div class="flex relative mt-4">
            ...
            <footer class="flex flex-col items-center justify-end px-6 py-3 -mx-6 -mb-4 space-y-4 sm:space-y-0 sm:space-x-6 sm:flex-row bg-gray-50 dark:bg-gray-800">
                <button name="add_discount" type="submit" @click="closeModal"
